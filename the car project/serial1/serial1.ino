...
float meas()
{
  float av = 0;
  /*  int count=0;
    Serial1.print("av is   -- ");Serial1.println(av);
    Serial1.print("count is   -- ");Serial1.println(count);
    Serial1.println();
    Serial1.println();
...
// Serial1.print("the 3rd value is ");  Serial1.println(av);
/*   Serial1.print("distance is ");Serial1.println(dist);
   Serial1.print("count is "); Serial1.println(count);

   if (k==0)
   {
     Serial1.print("first iteration  count must be 0");
      Serial1.println();
     Serial1.print("if executed once...count is -->> ");   Serial1.println(count);
   ...
   if (k==1)
   {   Serial1.print("second iteration  count must be 1");
       Serial1.println();
       Serial1.print("if executed once...count is -->> ");   Serial1.println(count);
   ...
   {
     count++ ;  Serial1.print("else if executed..count is  -->> ");Serial1.println(count);
     av=av+dist;  Serial1.print("av is   -->> ");              Serial1.println(av);
   Serial1.println();
   Serial1.println();
   Serial1.println();
   }
  ...
  Serial1.print("final count is ");  Serial1.println(count);                                         //Serial1.print(count );
  Serial1.print("final average is "); Serial1.print(av);                                           //Serial1.print(av);
  Serial1.println("  ");
  Serial1.println("  ");
  //delay(1000);*/
...
void printcheck()
{ int x = 4;
  Serial1.println("1 the value of x is -- >> "); Serial1.println(x); Serial1.println();
  Serial1.println("2");
  Serial1.println("3");
  Serial1.println();
  delay(5000);
