...
void testall()
{
  ...
  digitalWrite(iflr, LOW); delay(500);
  digitalWrite(iflr, HIGH); delay(500);
  digitalWrite(iflg, LOW);delay(500);
  digitalWrite(iflg, HIGH);delay(500);
  digitalWrite(iflb, LOW); delay(500);
  digitalWrite(iflb, HIGH); delay(500);
  digitalWrite(ifl, LOW); delay(500);
...
//front right indicator
 digitalWrite(ifr, HIGH);
  ...
  digitalWrite(ifrr, LOW); delay(500);
  digitalWrite(ifrr, HIGH); delay(500);
  digitalWrite(ifrg, LOW);delay(500);
  digitalWrite(ifrg, HIGH);delay(500);
  digitalWrite(ifrb, LOW); delay(500);
  digitalWrite(ifrb, HIGH); delay(500);
  digitalWrite(ifr, LOW); delay(500);
...
//headlamps
 digitalWrite(head, HIGH);
  ...
  digitalWrite(headr, LOW); delay(500);
  digitalWrite(headr, HIGH); delay(500);
  digitalWrite(headg, LOW);delay(500);
  digitalWrite(headg, HIGH);delay(500);
  digitalWrite(headb, LOW); delay(500);
  digitalWrite(headb, HIGH); delay(500);
  digitalWrite(head, LOW); delay(500);
...
//back right indicator
 digitalWrite(ibr, HIGH);
  ...
  digitalWrite(ibrr, LOW); delay(500);
  digitalWrite(ibrr, HIGH); delay(500);
  digitalWrite(ibrg, LOW);delay(500);
  digitalWrite(ibrg, HIGH);delay(500);
  digitalWrite(ibrb, LOW); delay(500);
  digitalWrite(ibrb, HIGH); delay(500);
  digitalWrite(ibr, LOW); delay(500);
...
//back left indicator
 digitalWrite(ibl, HIGH);
  ...
  digitalWrite(iblr, LOW); delay(500);
  digitalWrite(iblr, HIGH); delay(500);
  digitalWrite(iblg, LOW);delay(500);
  digitalWrite(iblg, HIGH);delay(500);
  digitalWrite(iblb, LOW); delay(500);
  digitalWrite(iblb, HIGH); delay(500);
  digitalWrite(ibl, LOW); delay(500);
...
//tail 
 digitalWrite(tail, HIGH);
  ...
  digitalWrite(tailr, LOW); delay(500);
  digitalWrite(tailr, HIGH); delay(500);
  digitalWrite(tailg, LOW);delay(500);
  digitalWrite(tailg, HIGH);delay(500);
  digitalWrite(tailb, LOW); delay(500);
  digitalWrite(tailb, HIGH); delay(500);
  digitalWrite(tail, LOW); delay(500);
