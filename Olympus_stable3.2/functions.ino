...
void sequence1()//1.90
{
  //  mod[1].definetype(0);  line();
  //  mod[2].definetype(0);  line();
  //  mod[3].definetype(1);  line();
  //  mod[4].definetype(1);  line();
  //  mod[5].definetype(1);  line();
  //  mod[6].definetype(0);  line();
  //  mod[7].definetype(1);  line();
  //  mod[8].definetype(0);  line();
  //  mod[9].definetype(0);  line();
  //  mod[10].definetype(0);  line();
  //  mod[11].definetype(0);  line();
